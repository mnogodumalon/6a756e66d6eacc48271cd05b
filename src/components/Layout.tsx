...
// Sprachwechsel: unser Switcher (einziger UI-Weg zu Tschechisch) UND die
// Plattform-Topnav (nur de/en) schreiben beide <html lang>; src/i18n
// beobachtet das Attribut und LocaleGate remountet den Baum.
import { t, appgroupLabel } from '@/i18n';

const APP_ID = '6a756e49599907d7a527484c';
const APPGROUP_ID = '6a756e66d6eacc48271cd05b';
