...
export function BestellverwaltungDialog({ open, onClose, onSubmit, defaultValues, recordId, fahrerverwaltungList, kundenverwaltungList, enablePhotoScan = true, enablePhotoLocation = true }: BestellverwaltungDialogProps) {
  ...
  const DIALOG_INTENT = defaultValues ? 'Bestellverwaltung bearbeiten' : 'Bestellverwaltung hinzufügen';

  const fieldBlocks: Record<string, React.ReactNode> = {
    'fahrer': (
      <div key="fahrer" className="space-y-1.5">
        <Label htmlFor="fahrer">Lieferfahrer</Label>
        <Combobox
          id="fahrer"
          placeholder="Welcher Fahrer?"
          ...
          createLabel="Neu in Fahrerverwaltung"
        />
      </div>
    ),
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        <Label htmlFor="delivery_notes">Lieferhinweise</Label>
        <Textarea
          id="delivery_notes"
          placeholder="Besonderheiten, Zugang, Klingel..."
    ...
    'order_date': (
      <div key="order_date" className="space-y-1.5">
        <Label htmlFor="order_date">Bestelldatum und -uhrzeit <span className="text-destructive" aria-hidden="true">*</span></Label>
        <DatePicker
          id="order_date"
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        <Label htmlFor="ordered_items">Bestellte Artikel <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Textarea
          id="ordered_items"
          placeholder="Was wurde bestellt? (Anzahl, Artikel)"
    ...
    'total_amount': (
      <div key="total_amount" className="space-y-1.5">
        <Label htmlFor="total_amount">Gesamtbetrag (€) <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="total_amount"
          type="number"
          step="any"
    ...
    'order_status': (
      <div key="order_status" className="space-y-1.5">
        <Label htmlFor="order_status">Bestellstatus <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Select
          value={lookupKey(fields.order_status) ?? ''}
          onValueChange={v => setFields(f => ({ ...f, order_status: v === 'none' ? undefined : v as any }))}
        >
          <SelectTrigger id="order_status" className="max-sm:h-11"><SelectValue placeholder="z. B. Neu, In Bearbeitung" /></SelectTrigger>
          <SelectContent>
            <SelectItem value="none">—</SelectItem>
            <SelectItem value="neu">Neu</SelectItem>
            <SelectItem value="in_bearbeitung">In Bearbeitung</SelectItem>
            <SelectItem value="bereit_zur_lieferung">Bereit zur Lieferung</SelectItem>
    ...
    'desired_delivery_time': (
      <div key="desired_delivery_time" className="space-y-1.5">
        <Label htmlFor="desired_delivery_time">Gewünschter Lieferzeitpunkt</Label>
        <DatePicker
          id="desired_delivery_time"
          placeholder="Gewünschtes Lieferdatum/Uhrzeit"
          mode="datetime"
    ...
    'delivery_street': (
      <div key="delivery_street" className="space-y-1.5">
        <Label htmlFor="delivery_street">Lieferstraße</Label>
        <Input
          id="delivery_street"
    ...
    'delivery_house_number': (
      <div key="delivery_house_number" className="space-y-1.5">
        <Label htmlFor="delivery_house_number">Lieferhausnummer</Label>
        <Input
    ...
    'delivery_postal_code': (
      <div key="delivery_postal_code" className="space-y-1.5">
        <Label htmlFor="delivery_postal_code">Lieferpostleitzahl</Label>
        <Input
    ...
    'delivery_city': (
      <div key="delivery_city" className="space-y-1.5">
        <Label htmlFor="delivery_city">Lieferstadt</Label>
        <Input
          id="delivery_city"
    ...
    'delivery_location': (
      <div key="delivery_location" className="space-y-1.5">
        <Label htmlFor="delivery_location">Lieferort auf Karte</Label>
