  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'fahrer': (
      <div key="fahrer" className="space-y-1.5">
        ...
        <Combobox
          id="fahrer"
          placeholder="Lieferfahrer zuweisen"
    ...
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        ...
        <Textarea
          id="delivery_notes"
          placeholder="Besonderheiten für die Zustellung..."
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        ...
        <Textarea
          id="ordered_items"
          placeholder="Auflistung der Artikel"
    ...
    'desired_delivery_time': (
      <div key="desired_delivery_time" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Gewünschter Liefertag und Uhrzeit"
          mode="datetime"
