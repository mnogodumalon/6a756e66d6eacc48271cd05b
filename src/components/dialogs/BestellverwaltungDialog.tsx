  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        ...
        <Textarea
          id="delivery_notes"
          placeholder="Treppenhaus-Nummer, Klingel, Besonderheiten..."
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        ...
        <Textarea
          id="ordered_items"
          placeholder="Was wurde bestellt? (z. B. 2× Pizza Margarita, 1× Salat...)"
    ...
    'order_status': (
      <div key="order_status" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="order_status" className="max-sm:h-11"><SelectValue placeholder="z. B. Neu, In Bearbeitung, Geliefert" /></SelectTrigger>
          <SelectContent>
