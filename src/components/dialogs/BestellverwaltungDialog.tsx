  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'fahrer': (
      <div key="fahrer" className="space-y-1.5">
        ...
        <Combobox
          id="fahrer"
          placeholder="Fahrer für die Lieferung wählen"
    ...
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        ...
        <Textarea
          id="delivery_notes"
          placeholder="Klingeln, Hinweisschild, Versand-Hinweise..."
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        ...
        <Textarea
          id="ordered_items"
          placeholder="Was wird bestellt? (Artikel, Menge, ...)"
    ...
    'order_status': (
      <div key="order_status" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="order_status" className="max-sm:h-11"><SelectValue placeholder="Wähle einen Bestellstatus" /></SelectTrigger>
          <SelectContent>
    ...
    'delivery_street': (
      <div key="delivery_street" className="space-y-1.5">
        ...
        <Input
          id="delivery_street"
          placeholder="z. B. Lieferstraße 99"
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="Welcher Kunde bestellt?"
