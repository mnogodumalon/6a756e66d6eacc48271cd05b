  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'fahrer': (
      <div key="fahrer" className="space-y-1.5">
        ...
        <Combobox
          id="fahrer"
          placeholder="Lieferfahrer aus der Liste wählen"
    ...
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        ...
        <Textarea
          id="delivery_notes"
          placeholder="Zusätzliche Lieferanweisungen, Hinweise..."
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        ...
        <Textarea
          id="ordered_items"
          placeholder="Artikel, Menge, Größe, Varianten..."
    ...
    'order_status': (
      <div key="order_status" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="order_status" className="max-sm:h-11"><SelectValue placeholder="Aktuellen Bestellstatus wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'desired_delivery_time': (
      <div key="desired_delivery_time" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann soll geliefert werden?"
          mode="datetime"
