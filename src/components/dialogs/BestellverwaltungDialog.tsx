  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        ...
        <Textarea
          id="delivery_notes"
          placeholder="Besondere Lieferhinweise, Klingel, Stockwerk, Allergy-Infos..."
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        ...
        <Textarea
          id="ordered_items"
          placeholder="Was wird bestellt? (z. B. 2× Weihnachtskiste, 1× Mittagessenpaket...)"
    ...
    'order_status': (
      <div key="order_status" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="order_status" className="max-sm:h-11"><SelectValue placeholder="Wähle einen Status" /></SelectTrigger>
          <SelectContent>
    ...
    'desired_delivery_time': (
      <div key="desired_delivery_time" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann soll die Lieferung erfolgen?"
          mode="datetime"
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="Welcher Kunde wird beliefert?"
