  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'fahrer': (
      <div key="fahrer" className="space-y-1.5">
        ...
        <Combobox
          id="fahrer"
          placeholder="Wer liefert diese Bestellung?"
    ...
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        ...
        <Textarea
          id="delivery_notes"
          placeholder="Türklingel, Haustür, Parken, Besonderheiten..."
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        ...
        <Textarea
          id="ordered_items"
          placeholder="Liste der bestellten Artikel mit Mengen..."
    ...
    'order_status': (
      <div key="order_status" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="order_status" className="max-sm:h-11"><SelectValue placeholder="Neu, In Bearbeitung, Bereit, Unterwegs, Geliefert oder Storniert?" /></SelectTrigger>
          <SelectContent>
    ...
    'desired_delivery_time': (
      <div key="desired_delivery_time" className="space-y-1.5">
        ...
        <DatePicker
          ...
          placeholder="Wann soll die Bestellung ankommen?"
          mode="datetime"
    ...
    'kunde': (
      <div key="kunde" className="space-y-1.5">
        ...
        <Combobox
          id="kunde"
          placeholder="Welchen Kunden beliefern wir?"
