  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    ...
    'delivery_notes': (
      <div key="delivery_notes" className="space-y-1.5">
        ...
        <Textarea
          id="delivery_notes"
          placeholder="Klingeln, Zugang, Besonderheiten..."
    ...
    'ordered_items': (
      <div key="ordered_items" className="space-y-1.5">
        ...
        <Textarea
          id="ordered_items"
          placeholder="z. B. 2x Brot, 1x Milch, 3x Käse"
    ...
    'order_status': (
      <div key="order_status" className="space-y-1.5">
        ...
        >
          <SelectTrigger id="order_status" className="max-sm:h-11"><SelectValue placeholder="Bestellstatus wählen" /></SelectTrigger>
          <SelectContent>
    ...
    'delivery_street': (
      <div key="delivery_street" className="space-y-1.5">
        ...
        <Input
          id="delivery_street"
          placeholder="z. B. Lilienthalstraße"
