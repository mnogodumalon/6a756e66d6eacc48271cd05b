  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'first_name': (
      <div key="first_name" className="space-y-1.5">
        <Label htmlFor="first_name">Vorname <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="first_name"
          placeholder="z. B. Max"
    ...
    'last_name': (
      <div key="last_name" className="space-y-1.5">
        <Label htmlFor="last_name">Nachname <span className="text-destructive" aria-hidden="true">*</span></Label>
        <Input
          id="last_name"
    ...
    'customer_since': (
      <div key="customer_since" className="space-y-1.5">
        <Label htmlFor="customer_since">Kunde seit</Label>
        <DatePicker
          id="customer_since"
    ...
    'notes': (
      <div key="notes" className="space-y-1.5">
        ...
        <Textarea
          id="notes"
          placeholder="Besonderheiten, Allergien, Vorlieben..."
          value={fields.notes ?? ''}
