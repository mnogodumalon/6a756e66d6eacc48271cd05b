...
export default function BestellverwaltungDetailPage() {
  ...
  return (
    ...
    >
      <RecordHeader title={record.fields.delivery_street ?? appLabel('bestellverwaltung')} />
      ...
      <RecordSection title={t('details')} cols={2}>
        <RecordField label={fieldLabel('bestellverwaltung', 'fahrer')} value={getFahrerverwaltungDisplayName(record.fields.fahrer)} format="text" />
        ...
        <RecordField label={fieldLabel('bestellverwaltung', 'kunde')} value={getKundenverwaltungDisplayName(record.fields.kunde)} format="text" />
