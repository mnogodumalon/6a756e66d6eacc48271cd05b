...
const ENTITY_TABS = [
  { key: 'kundenverwaltung', pascal: 'Kundenverwaltung' },
  { key: 'fahrerverwaltung', pascal: 'Fahrerverwaltung' },
  { key: 'bestellverwaltung', pascal: 'Bestellverwaltung' },
] as const;
...
export default function AdminPage() {
  ...
  const getFieldMeta = useCallback((entity: EntityKey) => {
    const raw: any[] = (() => {
      switch (entity) {
        case 'kundenverwaltung': return KUNDENVERWALTUNG_FIELDS as any[];
        case 'fahrerverwaltung': return FAHRERVERWALTUNG_FIELDS as any[];
        case 'bestellverwaltung': return BESTELLVERWALTUNG_FIELDS as any[];
        default: return [];
      }
    })();
