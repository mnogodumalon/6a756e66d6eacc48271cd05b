...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [{"row": ["driver_first_name", "driver_last_name"]}, "driver_phone", "driver_email", "vehicle_type", "delivery_zone", "driver_status", {"row": ["work_start", "work_end"]}, "driver_notes"],
  defaults: {
