// Auto-generated. Per-entity form-enhancements config for "Fahrerverwaltung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [{"row": ["driver_first_name", "driver_last_name"]}, "driver_phone", "driver_email", "vehicle_type", "delivery_zone", "driver_status", "work_start", "work_end", "driver_notes"],
  defaults: {
    'vehicle_type': { kind: 'lookup', key: 'pkw', label: 'PKW' },
