...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [{"row": ["first_name", "last_name"]}, "email", "phone", {"row": ["street", "house_number"], "cols": "2fr 1fr"}, {"row": ["postal_code", "city"], "cols": "1fr 2fr"}, "customer_since", "customer_status", "notes"],
  defaults: {
