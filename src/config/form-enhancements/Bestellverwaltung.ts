...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["kunde", "fahrer", "order_date", "desired_delivery_time", "order_status", "payment_method", "total_amount", "ordered_items", {"row": ["delivery_street", "delivery_house_number"], "cols": "2fr 1fr"}, {"row": ["delivery_postal_code", "delivery_city"]}, "delivery_notes"],
  defaults: {
