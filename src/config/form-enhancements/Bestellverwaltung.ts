...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["kunde", "fahrer", "order_date", "order_status", "payment_method", "ordered_items", "total_amount", "desired_delivery_time", {"row": ["delivery_street", "delivery_house_number"], "cols": "2fr 1fr"}, {"row": ["delivery_postal_code", "delivery_city"], "cols": "1fr 2fr"}, "delivery_notes"],
  defaults: {
