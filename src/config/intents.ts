...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/bestellung-aufnehmen', label: { de: 'Bestellung aufnehmen', en: 'New order', cs: 'Nová objednávka' }, icon: IconShoppingCartPlus, description: 'Neue Bestellung in 3 Schritten aufnehmen' },
  { path: '/intents/bestellung-zuweisen', label: { de: 'Fahrer zuweisen', en: 'Assign driver', cs: 'Přiřadit řidiče' }, icon: IconTruckDelivery, description: 'Bestellung einem verfügbaren Fahrer zuweisen' },
  // </custom:intents>
];
