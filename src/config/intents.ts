...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order' }, icon: IconShoppingCart, description: 'Neue Bestellung in drei Schritten anlegen' },
  { path: '/intents/bestellung-dispatchen', label: { de: 'Bestellung dispatchen', en: 'Dispatch Order' }, icon: IconTruck, description: 'Bestellung einem verfügbaren Fahrer zuweisen' },
  // </custom:intents>
];
