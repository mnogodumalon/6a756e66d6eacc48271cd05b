...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order', cs: 'Nová objednávka' }, icon: IconShoppingCart, description: 'Neue Bestellung in 3 Schritten aufgeben' },
  { path: '/intents/lieferung-abschliessen', label: { de: 'Lieferung', en: 'Delivery', cs: 'Doručení' }, icon: IconTruckDelivery, description: 'Bestellung ausliefern und abschließen' },
  // </custom:intents>
];
