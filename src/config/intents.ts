...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order', cs: 'Nová objednávka' }, icon: IconShoppingCart, description: 'Neue Lieferbestellung in 3 Schritten aufgeben' },
  { path: '/intents/bestellung-abwickeln', label: { de: 'Bestellung abwickeln', en: 'Process Order', cs: 'Zpracovat objednávku' }, icon: IconTruckDelivery, description: 'Aktive Bestellung mit Fahrer und Status abwickeln' },
  // </custom:intents>
];
