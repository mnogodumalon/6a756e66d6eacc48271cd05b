...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/bestellung-zuweisen', label: { de: 'Fahrer zuweisen', en: 'Assign driver' }, icon: IconTruckDelivery, description: 'Bestellung einem verfügbaren Fahrer zuweisen' },
  // </custom:intents>
];
