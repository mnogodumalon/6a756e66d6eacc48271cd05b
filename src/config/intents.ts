...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/bestellung-aufgeben', label: { de: 'Bestellung aufgeben', en: 'Place order' }, icon: IconShoppingCartPlus, description: 'Neue Bestellung in 3 Schritten aufgeben' },
  { path: '/intents/bestellung-dispatchen', label: { de: 'Bestellung dispatchen', en: 'Dispatch order' }, icon: IconTruckDelivery, description: 'Offene Bestellung einem Fahrer zuweisen' },
  // </custom:intents>
];
