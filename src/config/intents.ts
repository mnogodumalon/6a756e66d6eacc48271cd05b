...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/bestellung-aufgeben', label: { de: 'Bestellung aufgeben', en: 'Place order' }, icon: IconShoppingCart, description: 'Neue Bestellung in 3 Schritten aufgeben' },
  { path: '/intents/lieferung-abschliessen', label: { de: 'Lieferung abschließen', en: 'Complete delivery' }, icon: IconTruckDelivery, description: 'Bestellung einem Fahrer zuweisen und ausliefern' },
  // </custom:intents>
];
