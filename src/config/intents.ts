...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/lieferung-zuweisen', label: 'Lieferung zuweisen', icon: IconTruckDelivery, description: 'Fahrer zuweisen und Lieferung starten' },
  { path: '/intents/lieferung-abschliessen', label: 'Lieferung abschließen', icon: IconCircleCheck, description: 'Lieferungen als zugestellt markieren' },
  // </custom:intents>
];
