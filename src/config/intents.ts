...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order' }, icon: IconShoppingCart, description: 'Neue Lieferbestellung in 3 Schritten anlegen' },
  { path: '/intents/lieferung-abschliessen', label: { de: 'Lieferung abschließen', en: 'Complete Delivery' }, icon: IconTruckDelivery, description: 'Aktive Bestellung als geliefert abschließen' },
  // </custom:intents>
];
