...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order' }, icon: IconShoppingCart, description: 'Neue Bestellung in 3 Schritten aufgeben' },
  { path: '/intents/bestellung-zuweisen', label: { de: 'Bestellung zuweisen', en: 'Assign Order' }, icon: IconTruckDelivery, description: 'Bestellung einem verfügbaren Fahrer zuweisen' },
  // </custom:intents>
];
