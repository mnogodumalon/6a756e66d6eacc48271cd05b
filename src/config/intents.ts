...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/bestellung-aufgeben', label: { de: 'Bestellung aufgeben', en: 'Place Order' }, icon: IconShoppingCart, description: 'Neue Bestellung in wenigen Schritten anlegen' },
  { path: '/intents/lieferung-dispatchen', label: { de: 'Lieferung dispatchen', en: 'Dispatch Delivery' }, icon: IconTruck, description: 'Bestellung einem Fahrer zuweisen und losschicken' },
  // </custom:intents>
];
