...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/bestellung-zuweisen', label: { de: 'Bestellung zuweisen', en: 'Assign Order', cs: 'Přiřadit objednávku' }, icon: IconTruckDelivery, description: 'Offene Bestellung einem Fahrer zuweisen' },
  // </custom:intents>
];
