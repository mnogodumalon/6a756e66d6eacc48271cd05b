...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order' }, icon: IconShoppingCart, description: 'Bestellung in 4 Schritten aufgeben' },
  { path: '/intents/bestellung-zuweisen', label: { de: 'Bestellung zuweisen', en: 'Assign Order' }, icon: IconTruck, description: 'Fahrer zuweisen und Lieferstatus aktualisieren' },
  // </custom:intents>
];
