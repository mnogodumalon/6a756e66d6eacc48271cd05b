...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order' }, icon: IconShoppingCart, description: 'Neue Bestellung in 3 Schritten anlegen' },
  { path: '/intents/lieferung-abschliessen', label: { de: 'Lieferung abschließen', en: 'Close Delivery' }, icon: IconTruckDelivery, description: 'Bestellung als geliefert abschließen und Fahrer freistellen' },
  // </custom:intents>
];
