...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/neue-bestellung', label: { de: 'Neue Bestellung', en: 'New Order', cs: 'Nová objednávka' }, icon: IconShoppingCartPlus, description: 'Bestellung in 3 Schritten anlegen' },
  { path: '/intents/bestellung-abwickeln', label: { de: 'Bestellung abwickeln', en: 'Dispatch Order', cs: 'Vyřídit objednávku' }, icon: IconTruckDelivery, description: 'Bestellung einem Fahrer zuweisen und versenden' },
  // </custom:intents>
];
