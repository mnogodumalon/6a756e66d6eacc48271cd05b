...
export const INTENTS: IntentLink[] = [
  ...
  { path: '/intents/lieferung-verwalten', label: { de: 'Lieferung verwalten', en: 'Manage Delivery' }, icon: IconTruck, description: 'Aktive Bestellungen verwalten und Status aktualisieren' },
  // </custom:intents>
];
