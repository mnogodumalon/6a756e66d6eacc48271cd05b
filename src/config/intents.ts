...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/bestellung-aufnehmen', label: { de: 'Bestellung aufnehmen', en: 'New Order' }, icon: IconShoppingCartPlus, description: 'Neue Lieferbestellung in drei Schritten anlegen' },
  { path: '/intents/bestellung-ausliefern', label: { de: 'Bestellung ausliefern', en: 'Deliver Order' }, icon: IconTruckDelivery, description: 'Lieferbereite Bestellung einem Fahrer zuweisen und ausliefern' },
  // </custom:intents>
];
