...
// <custom:imports>
const BestellungAufnehmenPage = lazy(() => import('@/pages/intents/BestellungAufnehmenPage'));
const BestellungAusliefernPage = lazy(() => import('@/pages/intents/BestellungAusliefernPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/bestellung-aufnehmen" element={<Suspense fallback={null}><BestellungAufnehmenPage /></Suspense>} />
                <Route path="intents/bestellung-ausliefern" element={<Suspense fallback={null}><BestellungAusliefernPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
