...
const BestellungZuweisenPage = lazy(() => import('@/pages/intents/BestellungZuweisenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/bestellung-zuweisen" element={<Suspense fallback={null}><BestellungZuweisenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
