...
const BestellungAbschliessenPage = lazy(() => import('@/pages/intents/BestellungAbschliessenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/bestellung-abschliessen" element={<Suspense fallback={null}><BestellungAbschliessenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
