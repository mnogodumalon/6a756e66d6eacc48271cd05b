...
const LieferungDispatchPage = lazy(() => import('@/pages/intents/LieferungDispatchPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/lieferung-dispatch" element={<Suspense fallback={null}><LieferungDispatchPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
