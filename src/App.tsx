...
const LieferungVerwaltenPage = lazy(() => import('@/pages/intents/LieferungVerwaltenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/lieferung-verwalten" element={<Suspense fallback={null}><LieferungVerwaltenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
