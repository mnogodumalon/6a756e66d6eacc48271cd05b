...
const LieferungStartenPage = lazy(() => import('@/pages/intents/LieferungStartenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="intents/lieferung-starten" element={<Suspense fallback={null}><LieferungStartenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
