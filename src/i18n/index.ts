      ...
      "fahrerverwaltung": {
        ...
        "lookups": {
          "vehicle_type": {
            "fahrrad": "Kolo",
            "e_bike": "E-kolo",
            "motorroller": "Motorový skútr",
            "pkw": "Osobní automobil",
            "transporter": "Dodávka"
          },
          "driver_status": {
            "verfuegbar": "Dostupný",
            "im_einsatz": "V provozu",
...
export let locale: Locale = readStored() ?? BUILD_LOCALE;

// The la-* web components read their UI language from <html lang> at their
// own render time — keep it in sync from the first paint on.
