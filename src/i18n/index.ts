    ...
    "apps": {
      ...
      "bestellverwaltung": {
        ...
        "fields": {
          ...
          "order_date": "Bestelldatum und -uhrzeit",
          "ordered_items": "Bestellte Artikel",
          "total_amount": "Gesamtbetrag (€)",
          "order_status": "Bestellstatus",
          "payment_method": "Zahlungsmethode",
          "desired_delivery_time": "Gewünschter Lieferzeitpunkt",
          "delivery_street": "Lieferstraße",
          "delivery_house_number": "Lieferhausnummer",
          "delivery_postal_code": "Lieferpostleitzahl",
          "kunde": "Kunde",
          "delivery_city": "Lieferstadt",
          "delivery_location": "Lieferort auf Karte"
        },
        "lookups": {
          "order_status": {
            "neu": "Neu",
          ...
          "payment_method": {
            "bar": "Barzahlung bei Lieferung",
            "ec_karte": "EC-Karte bei Lieferung",
            "paypal": "PayPal",
    ...
    "apps": {
      ...
      "fahrerverwaltung": {
        ...
        "fields": {
          ...
          "driver_status": "Availability Status",
      ...
      "bestellverwaltung": {
        ...
        "fields": {
          ...
          "desired_delivery_time": "Requested Delivery Time",
          "delivery_street": "Delivery Street",
          "delivery_house_number": "Delivery House Number",
          "delivery_postal_code": "Delivery Postal Code",
          "kunde": "Customer",
          "delivery_city": "Delivery City",
          "delivery_location": "Delivery Location on Map"
        },
        "lookups": {
          "order_status": {
            "neu": "New",
            "in_bearbeitung": "In Progress",
            "bereit_zur_lieferung": "Ready for Delivery",
            "unterwegs": "Out for Delivery",
            "geliefert": "Delivered",
            "storniert": "Cancelled"
          },
          "payment_method": {
            "bar": "Cash on Delivery",
            "ec_karte": "Debit Card on Delivery",
            "paypal": "PayPal",
    ...
    "apps": {
      "kundenverwaltung": {
        ...
        "fields": {
          ...
          "postal_code": "PSČ",
          "city": "Město",
          "customer_since": "Zákazník od",
          "customer_status": "Stav zákazníka",
          "notes": "Poznámky"
        },
        "lookups": {
          "customer_status": {
      ...
      "fahrerverwaltung": {
        "name": "Správa řidičů",
        "fields": {
          "driver_first_name": "Jméno",
          "driver_last_name": "Příjmení",
          "driver_phone": "Telefonní číslo",
          "driver_email": "E-mailová adresa",
          "vehicle_type": "Typ vozidla",
          "delivery_zone": "Oblast doručení",
          "driver_status": "Stav dostupnosti",
          "work_start": "Začátek pracovní doby",
          "work_end": "Konec pracovní doby",
          "driver_notes": "Poznámky"
        },
        "lookups": {
          "vehicle_type": {
            "fahrrad": "Kolo",
          ...
          "driver_status": {
            "verfuegbar": "Dostupný",
            "im_einsatz": "Ve službě",
            "nicht_verfuegbar": "Nedostupný",
            "inaktiv": "Neaktivní"
          }
        }
      },
      "bestellverwaltung": {
        ...
        "fields": {
          "fahrer": "Doručovací řidič",
          "delivery_notes": "Pokyny k doručení",
          ...
          "desired_delivery_time": "Požadovaný čas doručení",
          "delivery_street": "Ulice doručení",
          "delivery_house_number": "Číslo popisné doručení",
          "delivery_postal_code": "PSČ doručení",
          "kunde": "Zákazník",
          "delivery_city": "Město doručení",
          "delivery_location": "Místo doručení na mapě"
        },
        "lookups": {
          "order_status": {
            "neu": "Nová",
            "in_bearbeitung": "Zpracovává se",
            "bereit_zur_lieferung": "Připravena k doručení",
            "unterwegs": "Na cestě",
            "geliefert": "Doručena",
            "storniert": "Stornována"
          },
          "payment_method": {
            "bar": "Hotovost při doručení",
            "ec_karte": "Platební karta při doručení",
            "paypal": "PayPal",
            "ueberweisung": "Bankovní převod",
