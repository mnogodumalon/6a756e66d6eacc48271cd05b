...
| `src/i18n/index.ts` | Runtime language layer (de/en/cs): `t()`, `makeT()`, `appLabel()`, `fieldLabel()`, `lookupLabel()`, formats — DO NOT edit |
| `src/components/LanguageSwitcher.tsx` | Header language switcher — DO NOT edit |
